...
CREATE TABLE `Acquisti` (
  ...
  `PrezzoScontato` int(10) unsigned NOT NULL,
  KEY `fk_Acquisti_2_idx` (`idCliente`),
  KEY `fk_Acquisti_1_idx` (`idOggetto`),
  CONSTRAINT `fk_Acquisti_1` FOREIGN KEY (`idOggetto`) REFERENCES `Oggetti` (`idOggetto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Acquisti_2` FOREIGN KEY (`idCliente`) REFERENCES `Clienti` (`idCliente`) ON DELETE NO ACTION ON UPDATE NO ACTION
